...
작업 목록
    ...
    1.게임 전용 HP/MP 체크 이벤트 발생(작업중 => WPF 내부 오류 수정 작업에 의하여 작업 딜레이 발생, 기능 구현까지 2주후 완성)
...
2.4.3
    ...
    - 블루스택 지원 (닉네임 감사합니다. 제공)

    - 현재 게임내의 HP, MP 체크 이후 매크로 발생을 시키는 작업을 개발 중에 있습니다. 당분간 패치가 늦을 수도 있습니다.
